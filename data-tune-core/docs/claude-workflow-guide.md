...
2. **Provide High-Level Updates**
   - Brief explanation of what was done
   - Not overly detailed - just the key points
   - Example: "Created customer segmentation query with RFM analysis"
...
**Remember**: Quality over speed. Simple over complex. Complete over temporary.
